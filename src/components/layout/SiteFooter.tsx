    ...
    <footer className="mt-24 border-t border-border bg-surface">
      <div className="container-wide py-16">
        ...
        <div className="mt-12 rounded-lg border border-border bg-background p-5 text-xs text-muted-foreground flex items-start gap-3">
          ...
          <p>
            <strong className="text-foreground">Research Use Only.</strong> The products sold by Renovo Peptides UK are intended
            ...
            intended for human or animal consumption, diagnostic, therapeutic or any clinical use.
          </p>
        </div>

        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} Renovo Peptides UK Ltd. All rights reserved.</p>
          <p className="font-mono uppercase tracking-widest">Registered in England & Wales · No. 16952545</p>
        </div>
      </div>
    </footer>
  );
